...
# Usage:
# cmdout_add_gtest(target source1 [source2...]
#          [DEPENDS lib1 [lib2...]]
# )
# NOTE:
# DEPENDS GTest::Main will be always added.
function(cmdout_add_gtest test_target)
	set(options) # N/A
	...
	target_link_libraries(${test_target} PRIVATE GTest::Main)
